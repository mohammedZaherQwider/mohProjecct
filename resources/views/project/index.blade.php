            ...
            <div class="row">
                ...
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <div class="heading-content" data-aos="fade-up">
                        ...
                        <p class="my-4" data-aos="fade-up" data-aos-delay="300"><a href="{{ route('home.services') }}"
            ...
            <div class="destination-slider">
                @foreach ($posts as $post)
                    <div class="destination">
                        <div class="{{ $post->image }}" alt="Image" class="img-fluid">
                            <div class="price">${{ $post->price }}</div>
                        </div>
                        <div class="mt-4">
                            <h3><a href="#">{{ $post->title }}</a></h3>
                            <span class="meta">{{ $post->description }}</span>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5 mb-4 mb-lg-0 order-lg-2" data-aos="fade-up">
                    <img src="{{ $postLast->image }}" alt="Image" class="img-fluid">
                </div>
                <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
                    <h2 class="heading mb-4">{{ $postLast->title }}</h2>
                    <p> {{ $postLast->description }}.</p>
                    ...
                    <div class="item">
                        <blockquote class="block-testimonial">
                            <div class="author">
                                ...
                                <p class="position mb-5">{{ $testimonial->job }}</p>
                            </div>
                            <p>
                            <div class="quote">&ldquo;</div>
                            &ldquo;{{ $testimonial->comment }}.&rdquo;</p>
                        </blockquote>
                    </div>
                @endforeach
            </div>
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5 mb-4 mb-lg-0">
                    <img src="{{asset('asset/images/img_v_2.jpg') }}" alt="Image" class="img-fluid">
                </div>
                ...
                @for ($i = 1; $i < 5; $i++)
                    ...
                    <div class="col-6 col-sm-6 col-md-6 col-lg-3" data-aos="fade-up"
                        ...
                        <div class="media-entry">
                            <a href="#">
                                <img src="{{ $postR->image }}" alt="Image" class="img-fluid">
                            </a>
                            <div class="bg-white m-body">
                                <span class="date"> {{ date('j M Y', strtotime($postR->created_at)) }}</span>
                                <h3><a href="#">{{ $postR->description }}.</p>
